...
public class SwitchStatementOldStyle extends StatementWithExpression implements HasSwitchLabels {
    ...
    public OutputBuilder output(Qualification qualification, LimitedStatementAnalysis statementAnalysis) {
        ...
        if (statementAnalysis == null) {
            outputWithoutStatementAnalysis(qualification, outputBuilder);
    ...
    private void outputWithoutStatementAnalysis(Qualification qualification, OutputBuilder outputBuilder) {
        Guide.GuideGenerator guideGenerator = Guide.generatorForBlock();
        outputBuilder.add(guideGenerator.start());
        ...
        for (Statement statement : structure.getStatements()) {
            ...
            outputBuilder.add(statement.output(qualification, null));
            statementCount++;
        }
        if (statementGg != null) {
            outputBuilder.add(statementGg.end());
