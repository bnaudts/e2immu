...
public class TestWeightedGraph_7B extends CommonWG {
    ...
    public void beforeEach() {
        ...
        LV.Links l01to01 = new LV.Links(Map.of(i0, new LV.Link(i00, false), i1, new LV.Link(i01, false)));
        ...
        LV entry_4_t = LV.createHC(new LV.Links(1, LV.ALL));
