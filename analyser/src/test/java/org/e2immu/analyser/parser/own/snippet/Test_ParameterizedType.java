...
public class Test_ParameterizedType extends CommonTestRunner {
    ...
    public void test_2() throws IOException {
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            ...
            if ("from".equals(d.methodInfo().name)) {
                ...
                String expected = d.iteration() < 12 ? "<m:from>" :
                        "'*'==signature.charAt(0)?new Result(ParameterizedType.WILDCARD_PARAMETERIZED_TYPE,1,false):'L'==('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?signature.charAt(1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0)):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?ParameterizedType_2.normalType(typeContext,findType,signature,'['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?1+('['==instance 0 type char?1+instance 0 type int:0):0,'+'==signature.charAt(0)?WildCard.EXTENDS:'-'==signature.charAt(0)?WildCard.SUPER:WildCard.NONE,'['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0):'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0):'T'==('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?signature.charAt(1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0)):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?null==typeContext.get(signature.substring(1+('['==('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?signature.charAt(1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0)):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?1+('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0):'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0):'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0),signature.indexOf(';')),false)?new Result(typeContext.getPrimitives().objectParameterizedType(),signature.indexOf(';')+1,true):new Result(new ParameterizedType((TypeParameter)typeContext.get(signature.substring(1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0),signature.indexOf(';')),false),'['==instance 0 type char?1+instance 0 type int:0,'+'==signature.charAt(0)?WildCard.EXTENDS:'-'==signature.charAt(0)?WildCard.SUPER:WildCard.NONE),signature.indexOf(';')+1,false):('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?1+('['==instance 0 type char?1+instance 0 type int:0):0)>=1?new Result(new ParameterizedType(scope-primitivePt:0.typeInfo,'['==instance 0 type char?1+instance 0 type int:0),('['==instance 0 type char?1+instance 0 type int:0)+1,false):new Result(switch('['==('['==instance 0 type char?signature.charAt(1+instance 0 type int):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0))?signature.charAt(1+('['==instance 0 type char?1+instance 0 type int:'+'==signature.charAt(0)||'-'==signature.charAt(0)?1:0)):'+'==signature.charAt(0)||'-'==signature.charAt(0)?signature.charAt(1):signature.charAt(0)){'B'->typeContext.getPrimitives().byteParameterizedType();'C'->typeContext.getPrimitives().charParameterizedType();default->throw new RuntimeException(\"Char \"+firstChar+\" does NOT represent a primitive!\");},1,false)";
                assertEquals(expected, d.methodAnalysis().getSingleReturnValue().toString());
    ...
    public void test_2_1() throws IOException {
        TypeAnalyserVisitor typeAnalyserVisitor = d -> {
            ...
            if ("ParameterizedType".equals(d.typeInfo().simpleName)) {
                assertDv(d, 18, MultiLevel.EFFECTIVELY_IMMUTABLE_DV, Property.IMMUTABLE);
            }
            if ("IterativeParsing".equals(d.typeInfo().simpleName)) {
                assertDv(d, 19, MultiLevel.EFFECTIVELY_IMMUTABLE_DV, Property.IMMUTABLE);
            }
            if ("Result".equals(d.typeInfo().simpleName)) {
                assertDv(d, 19, MultiLevel.EFFECTIVELY_IMMUTABLE_DV, Property.IMMUTABLE);
            }
        };
        BreakDelayVisitor breakDelayVisitor = d -> assertEquals("------S--S-S-SF--SF------", d.delaySequence());
