...
public class Test_51_InstanceOf extends CommonTestRunner {
    ...
    public void test_0() throws IOException {
            ...
            if ("method".equals(d.methodInfo().name)) {
                if (d.variable() instanceof ReturnVariable) {
                    if ("0".equals(d.statementId())) {
                        String expect = "in instanceof Number?\"Number: \"+in/*(Number)*/:<return value>";
        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                if ("0".equals(d.statementId())) {
                    assertEquals("null==in||!(in instanceof Number)",
                ...
                if (d.variable() instanceof ReturnVariable) {
                    ...
                    if ("1".equals(d.statementId())) {
                        String expected = d.iteration() == 0
                                ...
                                : "collection instanceof List<String>?collection/*(List<String>)*/.isEmpty()?\"Empty\":collection/*(List<String>)*/.get(0):<return value>";
                        assertEquals(expected, d.currentValue().toString());
    ...
    public void test_8() throws IOException {
        EvaluationResultVisitor evaluationResultVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                if ("0".equals(d.statementId())) {
                    assertEquals("in instanceof String", d.evaluationResult().getExpression().toString());
                }
            }
        ...
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                ...
                if (d.variable() instanceof ReturnVariable) {
                    if ("0".equals(d.statementId())) {
                        assertEquals("in instanceof String?in.toString():<return value>", d.currentValue().toString());
                    }
                    if ("1".equals(d.statementId())) {
                        assertEquals("in instanceof String?in.toString():\"Object\"", d.currentValue().toString());
                    }
                }
            }
            if ("method2".equals(d.methodInfo().name)) {
        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                if ("0".equals(d.statementId())) {
                    assertEquals("CM{state=null==in||!(in instanceof String);parent=CM{}}",
    ...
    public void test_9() throws IOException {
        EvaluationResultVisitor evaluationResultVisitor = d -> {
            if ("create".equals(d.methodInfo().name)) {
                if ("1".equals(d.statementId())) {
                    String expected = "object instanceof Boolean";
                ...
                if (d.variable() instanceof ReturnVariable) {
                    if ("0".equals(d.statementId())) {
                        String expected = switch (d.iteration()) {
                            case 0, 1 -> "object instanceof String?<new:StringConstant>:<return value>";
                            default -> "object instanceof String?new StringConstant(object/*(String)*/):<return value>";
                        };
                        assertEquals(expected, d.currentValue().toString());
                    }
                    if ("1".equals(d.statementId())) {
                        String expected = switch (d.iteration()) {
                            case 0 ->
                                    "object instanceof String?<new:StringConstant>:object instanceof Boolean?<new:BooleanConstant>:<return value>";
                            case 1 ->
                                    "object instanceof String?<new:StringConstant>:object instanceof Boolean?new BooleanConstant(object/*(Boolean)*/):<return value>";
                            default ->
                                    "object instanceof String?new StringConstant(object/*(String)*/):object instanceof Boolean?new BooleanConstant(object/*(Boolean)*/):<return value>";
                        };
                        assertEquals(expected, d.currentValue().toString());
                    }
                    if ("1.0.0".equals(d.statementId())) {
        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("create".equals(d.methodInfo().name)) {
                if ("0.0.0".equals(d.statementId())) {
                    assertEquals("object instanceof String", d.condition().toString());
                }
                if ("0".equals(d.statementId())) {
                ...
                if ("2.0.0".equals(d.statementId())) {
                    String expected = "object instanceof Integer";
                    assertEquals(expected, d.condition().toString());
                }
                if ("2".equals(d.statementId())) {
                    assertEquals("true", d.condition().toString());
    ...
    public void test_10() throws IOException {
        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                if ("2.0.0".equals(d.statementId())) {
                    assertEquals("expression instanceof Negation", d.condition().toString());
                }
            }
        };
            ...
            if ("method".equals(d.methodInfo().name)) {
                if (d.variable() instanceof ParameterInfo p && "expression".equals(p.name)) {
                    if ("2.0.0".equals(d.statementId())) {
                        ...
                        String expected = d.iteration() < 2 ? "ne.expression:-1,ne:-1,x:-1" : "ne:1";
                    ...
                    if ("<out of scope:ne:2>".equals(fr.scope().toString())) {
                        if ("2".equals(d.statementId())) {
                            String expected = switch (d.iteration()) {
                                case 0 -> "<f:expression>";
                                case 1 ->
                                        "expression instanceof Negation?<f:expression>:nullable instance type Expression";
                ...
                if ("x".equals(d.variableName())) {
                    if ("2.0.0".equals(d.statementId())) {
                        assertCurrentValue(d, 2, "expression/*(Negation)*/.expression");
    ...
    public void test_11() throws IOException {
        EvaluationResultVisitor evaluationResultVisitor = d -> {
            if ("0.0.1.0.0".equals(d.statementId())) {
                ...
                String linked = switch (d.iteration()) {
                    case 0, 1 -> "sum:-1,this.expression:-1,this:-1,v:-1";
                    case 2 -> "v:-1";
                    default -> "";
                };
            ...
            if ("0.0.1".equals(d.statementId())) {
                String expected = d.iteration() < 3 ? "!<null-check>" : "null!=expression/*(Sum)*/.numericPartOfLhs()";
                assertEquals(expected, d.evaluationResult().value().toString());
            }
        };
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                if (d.variable() instanceof ParameterInfo p && "evaluationContext".equals(p.name)) {
                    ...
                    if ("0.0.1.0.0".equals(d.statementId())) {
                        ...
                        String expectLv = d.iteration() < 3 ? "d:-1,sum:-1,this.expression:-1,this:-1,v:-1" : "";
                        assertEquals(expectLv, d.variableInfo().getLinkedVariables().toString());

                        //  after second delay breaking
                        String expected = d.iteration() < 3 ? "<p:evaluationContext>"
                                : "nullable instance type EvaluationContext/*@Identity*/";
                        assertEquals(expected, d.currentValue().toString());
                    ...
                    if ("0.0.1.0.5".equals(d.statementId())) {
                        assertLinked(d, it0("b:-1,d:-1,lessThan:-1,scope-ne1:0.0.1.0.4.expression:-1,scope-ne1:0.0.1.0.4:-1,sum:-1,this.expression:-1,this:-1,v:-1,x:-1"),
                                it(1, 2, "b:-1,d:-1,scope-ne1:0.0.1.0.4.expression:-1,scope-ne1:0.0.1.0.4:-1,sum:-1,this.expression:-1,this:-1,v:-1,x:-1"),
                                it(3, ""));
                    }
                ...
                if (d.variable() instanceof FieldReference fr && "expression".equals(fr.fieldInfo().name) && fr.scopeIsThis()) {
                    if ("0.0.1.0.4.0.0".equals(d.statementId())) {
                        assertLinked(d,
                                ...
                                it(1, 2, "d:-1,evaluationContext:-1,ne1.expression:-1,ne1:-1,sum:-1,this:-1,v:-1,x:-1"),
                                it(3, "ne1:2,sum:1,this:3,v:2"));
                    }
                    if ("0.0.1.0.5".equals(d.statementId())) {
                        assertLinked(d, it0("b:-1,d:-1,evaluationContext:-1,lessThan:-1,scope-ne1:0.0.1.0.4.expression:-1,scope-ne1:0.0.1.0.4:-1,sum:-1,this:-1,v:-1,x:-1"),
                                it(1, 2, "b:-1,d:-1,evaluationContext:-1,scope-ne1:0.0.1.0.4.expression:-1,scope-ne1:0.0.1.0.4:-1,sum:-1,this:-1,v:-1,x:-1"),
                                it(3, "scope-ne1:0.0.1.0.4.expression:2,scope-ne1:0.0.1.0.4:2,sum:1,this:3,v:2,x:2"));
                    }
                ...
                if ("d".equals(d.variableName())) {
                    if ("0.0.0".equals(d.statementId())) {
                        String value = d.iteration() < 3 ? "<m:numericPartOfLhs>"
                                : "expression/*(Sum)*/.numericPartOfLhs()";
            ...
            if ("method".equals(d.methodInfo().name)) {
                if ("0.0.1.0.0".equals(d.statementId())) {
                    String expected = switch (d.iteration()) {
                        ...
                        case 1, 2 -> "expression instanceof Sum&&!<null-check>";
                        default -> "null!=expression/*(Sum)*/.numericPartOfLhs()&&expression instanceof Sum";
                    };
                    assertEquals(expected, d.localConditionManager().absoluteState(d.context()).toString());
                }
                if ("0.0.1.0.4.0.2".equals(d.statementId())) {
                    String expected = switch (d.iteration()) {
                        case 0 -> "<instanceOf:Sum>&&!<null-check>&&<instanceOf:Negation>";
                        case 1, 2 -> "expression instanceof Sum&&!<null-check>&&<instanceOf:Negation>";
                        default ->
                                "null!=expression/*(Sum)*/.numericPartOfLhs()&&expression instanceof Sum&&expression/*(Sum)*/.nonNumericPartOfLhs(evaluationContext) instanceof Negation";
                    };
                    assertEquals(expected, d.localConditionManager().absoluteState(d.context()).toString());
                }
        ...
        TypeAnalyserVisitor typeAnalyserVisitor = d -> {
            ...
            switch (d.typeInfo().simpleName) {
                ...
                case "InstanceOf_11" ->
                        assertDv(d, "cm@Parameter_evaluationContext", 4, MultiLevel.CONTAINER_DV, Property.CONTAINER);
                case "XB" ->
                        assertDv(d, "cm@Parameter_x;mom@Parameter_x", 1, MultiLevel.CONTAINER_DV, Property.CONTAINER);
    ...
    public void test_13() throws IOException {
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method".equals(d.methodInfo().name)) {
                ...
                if (d.variable() instanceof ReturnVariable) {
                    String expected = "in instanceof Number?\"Number: \"+in/*(Number)*/:\"\"+in";
                    assertEquals(expected, d.currentValue().toString());
                }
            }
        };
    ...
    public void test_16() throws IOException {
        EvaluationResultVisitor evaluationResultVisitor = d -> {
            if ("find".equals(d.methodInfo().name)) {
                if ("1".equals(d.statementId())) {
                    String expected = switch (d.iteration()) {
                        case 0 -> "expression instanceof UnaryOperator&&<m:isUnaryNot>";
                        default ->
                                "expression instanceof UnaryOperator&&expression/*(UnaryOperator)*/.operator.isUnaryNot()";
                    };
                    assertEquals(expected, d.evaluationResult().value().toString());
                    assertEquals(d.iteration() == 0, d.evaluationResult().causesOfDelay().isDelayed());
                }
                if ("1.0.0".equals(d.statementId())) {
                    String expected = d.iteration() < 4 ? "<m:toList>"
                ...
                if ("2".equals(d.statementId())) {
                    String delay = d.iteration() == 0 ? "initial:expression@Method_find_1-E;initial:unaryOperator.operator@Method_find_1-C"
                            : "";
                ...
                if ("3".equals(d.statementId())) {
                    String expected = switch (d.iteration()) {
                        case 0 ->
                                "<instanceOf:Negation>?<m:toList>:<instanceOf:UnaryOperator>&&<m:isUnaryNot>?<m:toList>:<instanceOf:InstanceOf>?<m:of>:<m:toList>";
                        case 1 ->
                                "expression instanceof Negation?<m:toList>:expression instanceof UnaryOperator&&<m:isUnaryNot>?<m:toList>:expression instanceof InstanceOf?<m:of>:(nullable instance 3 type List<Expression>).stream().flatMap(instance 3 type $3).toList()";
                        case 2, 3 ->
            ...
            if ("apply".equals(d.methodInfo().name) && "$1".equals(d.methodInfo().typeInfo.simpleName)) {
                assertEquals("0", d.statementId());
                String expected = d.iteration() < 3 ? "<new:InstanceOfPositive>" : "new InstanceOfPositive(iop.instanceOf,!iop.positive)";
                assertEquals(expected, d.evaluationResult().value().toString());
                ...
                if (d.variable() instanceof ParameterInfo pi && pi.owner == d.methodInfo() && "expression".equals(pi.name)) {
                    ...
                    if ("2".equals(d.statementId())) {
                        ...
                        String delay = switch (d.iteration()) {
                            case 0 ->
                                    "initial:expression@Method_find_1-E;initial:unaryOperator.operator@Method_find_1-C";
                            default -> "";
                        };
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            ...
            if ("clazz".equals(d.methodInfo().name)) {
                ...
                assertEquals(MultiLevel.EFFECTIVELY_IMMUTABLE_DV, classImmutable);
            }
        };
        TypeAnalyserVisitor typeAnalyserVisitor = d -> {
